...
$sql="SELECT * FROM credentials c, trash i
WHERE c.credentialsId = i.sen_id AND i.rec_id = '$id'";
...
$date=$rows->recDT;
                  ...
                  echo "<td class='mailbox-name'><a href=#>".$name."</a></td>";
                  echo "<td class='mailbox-subject'><b>".$sub."</b></td>"; 
                  echo "<td class='mailbox-attachment'></td>";
                  echo "<td class='mailbox-date'>".$date."</td>";  
                  //echo "<td class='mailbox-date'><a href='deleteMSG.php?id=$mid' class='btn btn-primary'>Delete</td>";
                  echo "<td class='mailbox-date'><a href='deleteAll.php?id=$mid' class='btn btn-primary' style='background-color:Tomato'>Delete</td>"; 				  
                  echo "</tr>";
                  }
              echo "</tbody>";    
              echo "</table>";  
