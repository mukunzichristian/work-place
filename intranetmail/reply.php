...
/*if(@$_REQUEST['save'])
{
  if($sub=="" || $msg=="")
  {
  $err= "<font color='blue'>fill subject and message first</font>";
  }
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <?php echo @$err; ?>
                <input type="text" name="to" class="form-control" placeholder="To:" value="<?php echo $_REQUEST['mail']; ?>">
              </div>
              <div class="form-group">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <!--<button type="submit" class="btn btn-default" name="save" value="save"><i class="fa fa-pencil"></i> Draft</button>-->
                <button type="submit" class="btn btn-primary" name="send" value="send"><i class="fa fa-envelope-o"></i> Send</button>
              </div>
              <button type="reset" class="btn btn-default" name="cancel" value="Cancel"><i class="fa fa-times"></i> Cancel</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
