          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><i class="fa fa-message"></i> Inbox
...
WHERE c.credentialsId = i.sen_id AND i.rec_id = '$id' AND i.status='inbox'";
...
$date=$rows->recDT;
  ...
  if(isset($_GET['delete']))
  {
    ...
    $d="DELETE from message where mail_id='$v'";
    mysqli_query($con,$d);
    }
    echo "msg deleted";
